...
func (UnimplementedOperatorServiceServer) GetPlane(context.Context, *GetPlaneRequest) (*Plane, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetPlane not implemented")
}
func (UnimplementedOperatorServiceServer) SyncPlane(context.Context, *SyncPlaneRequest) (*SyncPlaneResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SyncPlane not implemented")
}
